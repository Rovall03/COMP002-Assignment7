...
console.log("I liked the times we do the lecture activity together I retain information better that way");
...
console.log("All the concepts were new to me I had never worked with JS before .");
